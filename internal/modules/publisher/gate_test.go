...
func TestEnhanceContent_NilEnhancer(t *testing.T) {
	...
	out, _, _ := svc.enhanceContent(context.Background(), uuid.New(), nil, "T", "conteúdo original", "kw", "cat", "pt", "", "", nil)
...
func TestEnhanceContent_EmptyContent(t *testing.T) {
	...
	if out, _, _ := svc.enhanceContent(context.Background(), uuid.New(), nil, "T", "", "", "", "pt", "", "", nil); out != "" {
...
func TestEnhanceContent_AppliesResult(t *testing.T) {
	...
	out, _, _ := svc.enhanceContent(context.Background(), uuid.New(), nil, "Titulo", "conteúdo original", "kw", "cat", "pt", "", "", nil)
...
func TestEnhanceContent_FailsOpen(t *testing.T) {
	...
	out, _, _ := svc.enhanceContent(context.Background(), uuid.New(), nil, "T", "conteúdo original", "", "", "pt", "", "", nil)
	if out != "conteúdo original" {
